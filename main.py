...
if __name__ == '__main__':
	...
	with open(r'C:\Users\Пользователь\Desktop\homework\Python and bd. ORM\fixtures\tests_data.json', 'r') as fd:
		data = json.load(fd)
